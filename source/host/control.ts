...
module TSOS {
    ...
    export class Control {
        ...
        public static hostInit():void {
            ...
            _statusBar = <HTMLTextAreaElement>document.getElementById('statusBar');
            var d = new Date();
        ...
        public static emptyMemTable(): void {
            var counter = 0;
        ...
        public static updateMemTableLoc(tRow, tCell, myCode): void {
